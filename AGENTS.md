...
The bridge runs with `python3 scripts/start_bridge.py` at `http://127.0.0.1:8765/`. It reports source candidates but never writes `.tex` files. Do not commit generated files under `build/`.
